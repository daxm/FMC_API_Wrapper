...
class FMC(*args, **kwargs):
    """
    Placeholder class during deprecation warning period. Naming things is hard :)
    """
    from warnings import warn
    warnings.warn("FMC is deprecated, use Cluster instead", DeprecationWarning)
